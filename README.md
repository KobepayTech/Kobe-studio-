# kobeAi — Unrestricted Open-Source Alternative to AI Video Platforms

[![Powered by MuAPI](https://img.shields.io/badge/Powered%20by-MuAPI-6366f1?style=flat-square&logo=data:image/svg+xml;base64,)](https://muapi.ai?utm_source=github&utm_medium=badge&utm_campaign=kobe-ai)
...
**Hosted version:** [https://muapi.ai/kobe-ai?utm_source=github&utm_medium=readme&utm_campaign=kobe-ai](https://muapi.ai/kobe-ai?utm_source=github&utm_medium=readme&utm_campaign=kobe-ai)
...
| Platform | Download |
|---|---|
| macOS Apple Silicon (M1/M2/M3/M4) | [kobeAi-1.0.9-arm64.dmg](https://github.com/KobepayTech/Kobe-studio-/releases/download/v1.0.9/Open.Generative.AI-1.0.9-arm64.dmg) |
| macOS Intel (x64) | [kobeAi-1.0.9.dmg](https://github.com/KobepayTech/Kobe-studio-/releases/download/v1.0.9/Open.Generative.AI-1.0.9.dmg) |
| Windows (x64) | [kobeAi Setup 1.0.9.exe](https://github.com/KobepayTech/Kobe-studio-/releases/download/v1.0.9/Open.Generative.AI.Setup.1.0.9.exe) |
| Linux (Ubuntu x64) | [v1.0.9 release](https://github.com/KobepayTech/Kobe-studio-/releases/tag/v1.0.9) (`.AppImage` / `.deb`), or build locally with `npm run electron:build:linux`. |

All releases: [github.com/KobepayTech/Kobe-studio-/releases](https://github.com/KobepayTech/Kobe-studio-/releases)
...
```bash
xattr -cr "/Applications/kobeAi.app"
```
...
3. Scroll down to find _"kobeAi was blocked"_
...
- **AppImage** — portable, run directly after making executable:
  ```bash
  chmod +x "release/kobeAi-*.AppImage"
  ./release/Open\ Generative\ AI-*.AppImage
  ```
- **.deb** — install on Debian/Ubuntu:
  ```bash
  sudo apt install ./release/kobe-ai_*_amd64.deb
  ```
...
kobeAi is a free, open-source AI image, video, cinema, and lip sync studio that brings creative workflows to everyone. No content filters, no prompt rejections, no guardrails — just full creative freedom. Powered by [Muapi.ai](https://muapi.ai?utm_source=github&utm_medium=readme&utm_campaign=kobe-ai), it supports text-to-image, image-to-image, text-to-video, image-to-video, and audio-driven lip sync generation across models like Flux, Nano Banana, Midjourney, Kling, Sora, Veo, Seedream, Infinite Talk, LTX Lipsync, Wan 2.2, and more — all from a sleek, modern interface you can self-host and customize.

**Why kobeAi instead of other AI Video Platforms?**
...
- macOS: `~/Library/Application Support/kobe-ai/local-ai`
- Windows: `%APPDATA%\kobe-ai\local-ai`
- Linux: `~/.config/kobe-ai/local-ai`
...
APP_DATA="${OPEN_GENERATIVE_AI_LOCAL_AI_DIR:-$HOME/Library/Application Support/kobe-ai/local-ai}"
...
- A [Muapi.ai access key](https://muapi.ai/access-keys?utm_source=github&utm_medium=readme&utm_campaign=kobe-ai). Copy the generated key value into the app; do not enter the key name or label.

### Setup

> **Most users want the desktop app, not this dev path.** If you just want to run kobeAi on your machine, [download a prebuilt installer](#-download-desktop-app) instead — no Node.js required. The instructions below are for contributors building from source.
...
git clone --recurse-submodules https://github.com/KobepayTech/Kobe-studio-.git
cd KobeAi
...
Installers are output to the `release/` folder. Pre-built binaries are also available on the [Releases page](https://github.com/KobepayTech/Kobe-studio-/releases).
...
The `packages/studio` library is also consumed by the hosted version on [muapi.ai](https://muapi.ai?utm_source=github&utm_medium=readme&utm_campaign=kobe-ai) — model updates made in `packages/studio/src/models.js` apply to both the self-hosted app and the hosted version automatically.

## 🔌 API Integration

The app communicates with [Muapi.ai](https://muapi.ai?utm_source=github&utm_medium=readme&utm_campaign=kobe-ai) using a two-step pattern:
...
**kobeAi** is a community-driven, open-source alternative that provides similar creative capabilities without the closed ecosystem:

| | Other providers | kobeAi |
| :--- | :--- | :--- |
...
| **Hosted version** | Subscription | Free at [muapi.ai/kobe-ai](https://muapi.ai/kobe-ai?utm_source=github&utm_medium=readme&utm_campaign=kobe-ai) |
| **Self-hosting** | No | Yes |
...
Built with [Muapi.ai](https://muapi.ai?utm_source=github&utm_medium=readme&utm_campaign=kobe-ai) — the unified API for AI image and video generation models.
...
---
*Looking for a free, open-source AI Video Platform? kobeAi is an open-source AI image and video generation studio — with no content filters that you can self-host, customize, and extend.*
